...
- **parallel-worktrees** — the plan-optional counterpart to maestro: reach for it when a stage (usually **code**) fans out into independent slices with no formal plan docs to feed maestro. It handles the go/no-go, file partitioning, worktree isolation, and integration. Not a chain stage itself; a primitive any stage can invoke. Use maestro when plans exist, this when they do not.
