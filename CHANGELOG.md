...
## [Unreleased]
- commit-report: enforce a formal, impersonal voice across report prose, bullets and the channel block; voice config values are now impersonal (default) or third, with legacy first read as impersonal
